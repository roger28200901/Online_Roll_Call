...
CREATE TABLE `current_lists` (
  `id` int NOT NULL,
  `rollcalls_id` int NOT NULL COMMENT '點名單id',
  `name` text COLLATE utf8_unicode_ci NOT NULL COMMENT '姓名',
  `created_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;

--
-- 傾印資料表的資料 `current_lists`
--

INSERT INTO `current_lists` (`id`, `rollcalls_id`, `name`, `created_time`) VALUES
(1, 1, '陳昀鴻', '2022-01-14 15:41:27');
...
CREATE TABLE `rollcalls` (
  `id` int NOT NULL,
  `class_name` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `date` date NOT NULL,
...
CREATE TABLE `students` (
  `id` int NOT NULL,
  `rollcalls_id` int NOT NULL,
  `name` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `school_number` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `students` (`id`, `rollcalls_id`, `name`, `school_number`, `status`, `image_path`, `time`) VALUES
(1, 1, '陳X', '108AC1007', '辨識成功', 'images/108ac1007.png', '2021-11-24 13:37:00'),
(2, 1, '陳昀鴻', '108AC1007', '辨識成功', 'images/108ac1007.png', '2021-11-22 13:37:00');
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `current_lists`
--
ALTER TABLE `current_lists`
